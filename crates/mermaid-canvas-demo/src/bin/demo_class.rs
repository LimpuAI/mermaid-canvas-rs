//! Class Diagram 演示
//!
//! 用法: demo-class [--theme default|dark|forest] [--output <path>]
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let source = mermaid_canvas_demo::sample_data::class_sample();
    ...
    let title = format!("Mermaid Canvas - Class Diagram [{}]", cli.theme_name());
