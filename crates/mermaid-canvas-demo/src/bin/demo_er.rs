//! ER Diagram 演示
//!
//! 用法: demo-er [--theme default|dark|forest] [--output <path>]
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let source = mermaid_canvas_demo::sample_data::er_sample();
    ...
    let title = format!("Mermaid Canvas - ER Diagram [{}]", cli.theme_name());
