//! Packet Diagram 演示
//!
//! 用法: demo-packet [--theme default|dark|forest] [--output <path>]
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let source = mermaid_canvas_demo::sample_data::packet_sample();
    ...
    let title = format!("Mermaid Canvas - Packet Diagram [{}]", cli.theme_name());
