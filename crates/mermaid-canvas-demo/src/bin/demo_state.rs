//! State Diagram 演示
//!
//! 用法: demo-state [--theme default|dark|forest] [--output <path>]
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let source = mermaid_canvas_demo::sample_data::state_sample();
    ...
    let title = format!("Mermaid Canvas - State Diagram [{}]", cli.theme_name());
